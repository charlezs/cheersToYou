...
export function SearchBar({ profile }: props) {  const navigate = useNavigate()
  ...
  return (
    <form className="w-full px-6 flex items-center gap-x-4 border-b-4 border-b-white h-20 font-sans">
      ...
      <button
        type="submit"
        className="rounded-xl bg-white font-sans font-semibold text-blue-600 px-3 py-2 transition duration-300 ease-in-out hover:bg-yellow-100 hover:-translate-y-1"
      >
        Search
      </button>
